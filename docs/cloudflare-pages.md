...
- Projeto Pages: `elegancia-barbearia-site`
...
- `CLOUDFLARE_API_TOKEN=<somente no ambiente de deploy local/CI>`

O token do Cloudflare deve ficar fora do versionamento. Use `.env` ou um segredo do provedor de CI/CD.
