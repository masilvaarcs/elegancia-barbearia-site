<#
.SYNOPSIS
    Script de inicializacao do Elegancia Barbearia Template.
...
.EXAMPLE
    .\elegancia-start.ps1
    .\elegancia-start.ps1 -Mode dev -Port 3003
    .\elegancia-start.ps1 -Mode dev -Tier premium
    .\elegancia-start.ps1 -Mode build
    .\elegancia-start.ps1 -Mode preview
    .\elegancia-start-basic.ps1
    .\elegancia-start-superPremium.ps1
#>
...
Write-Host "║   Elegancia Barbearia — Start Script      ║" -ForegroundColor DarkCyan
Write-Host "╚══════════════════════════════════════════╝" -ForegroundColor DarkCyan
...
if ($Mode -eq "dev") {
    ...
    Write-Host "  .\elegancia-start-basic.ps1" -ForegroundColor DarkGray
    Write-Host "  .\elegancia-start-normal.ps1" -ForegroundColor DarkGray
    Write-Host "  .\elegancia-start-premium.ps1" -ForegroundColor DarkGray
    Write-Host "  .\elegancia-start-superPremium.ps1" -ForegroundColor DarkGray
    Write-Host "  Ou: .\elegancia-start.ps1 -Tier premium" -ForegroundColor DarkGray
    Write-Host ""
